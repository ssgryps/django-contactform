...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('contactform_contactformsubmissionattachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'ContactFormSubmissionAttachment.file'
        db.alter_column('contactform_contactformsubmissionattachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
