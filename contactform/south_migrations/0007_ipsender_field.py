...
class Migration:
    ...
    def forwards(self, orm):
        db.alter_column('contactform_contactformsubmission', 'sender_ip', models.CharField(max_length=40))
    
    def backwards(self, orm):
        db.alter_column('contactform_contactformsubmission', 'sender_ip', models.IPAddressField())
    ...
    models = {
        ...
        'contactform.contactformsubmission': {
            ...
            'sender_ip': ('models.CharField', [], {'default': "'unknown'", 'max_length': '40'}),
