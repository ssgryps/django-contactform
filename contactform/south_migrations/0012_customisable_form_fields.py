...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for field in orm.FormField.objects.all():
            changed = False
            if field.field_type:
                field.field_type = 'django.forms.%s' % field.field_type
                changed = True
            if field.widget:
                field.widget = 'django.forms.%s' % field.widget
                changed = True
            if changed:
                field.save()
    ...
    def backwards(self, orm):
        ...
        for field in orm.FormField.objects.all():
            changed = False
            if field.field_type:
                field.field_type = field.field_type.rsplit('.',1)[-1]
                changed = True
            if field.widget:
                field.widget = field.widget.rsplit('.',1)[-1]
                changed = True
            if changed:
                field.save()
