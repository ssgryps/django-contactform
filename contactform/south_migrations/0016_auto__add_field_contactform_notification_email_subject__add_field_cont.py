...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contactform_contactform', 'notification_email_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactForm.notification_email_body'
        db.add_column('contactform_contactform', 'notification_email_body',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('contactform_contactform', 'notification_email_subject')

        # Deleting field 'ContactForm.notification_email_body'
        db.delete_column('contactform_contactform', 'notification_email_body')
