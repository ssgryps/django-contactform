...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactForm.title'
        db.add_column('contactform_contactform', 'title', orm['contactform.contactform:title'])
        
        # Changing field 'ContactForm.name'
        # (to signature: django.db.models.fields.CharField(max_length=255))
        db.alter_column('contactform_contactform', 'name', orm['contactform.contactform:name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ContactForm.title'
        db.delete_column('contactform_contactform', 'title')
