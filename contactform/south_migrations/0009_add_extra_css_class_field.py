...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactForm.css_class'
        db.add_column('contactform_contactform', 'css_class', orm['contactform.contactform:css_class'])
        
        # Adding field 'FormField.css_class'
        db.add_column('contactform_formfield', 'css_class', orm['contactform.formfield:css_class'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ContactForm.css_class'
        db.delete_column('contactform_contactform', 'css_class')
        
        # Deleting field 'FormField.css_class'
        db.delete_column('contactform_formfield', 'css_class')
