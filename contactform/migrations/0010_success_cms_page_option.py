...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactForm.success_page'
        db.add_column('contactform_contactform', 'success_page', orm['contactform.contactform:success_page'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ContactForm.success_page'
        db.delete_column('contactform_contactform', 'success_page_id')
