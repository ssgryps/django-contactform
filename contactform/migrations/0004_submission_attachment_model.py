...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContactFormSubmissionAttachment'
        db.create_table('contactform_contactformsubmissionattachment', (
            ('id', models.AutoField(primary_key=True)),
            ('submission', models.ForeignKey(orm.ContactFormSubmission)),
            ('file', models.FileField()),
        ))
        db.send_create_signal('contactform', ['ContactFormSubmissionAttachment'])
    ...
    models = {
        ...
        'contactform.contactformsubmissionattachment': {
            'submission': ('models.ForeignKey', ["orm['contactform.ContactFormSubmission']"], {}),
            'file': ('models.FileField', [], {})
        },
    }
