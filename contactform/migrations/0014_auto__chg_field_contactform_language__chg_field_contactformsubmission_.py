...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactForm.language'
        db.alter_column('contactform_contactform', 'language', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ContactFormSubmission.form_data_pickle'
        db.alter_column('contactform_contactformsubmission', 'form_data_pickle', self.gf('contactform.fields.PickledObjectField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'ContactForm.language'
        db.alter_column('contactform_contactform', 'language', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'ContactFormSubmission.form_data_pickle'
        db.alter_column('contactform_contactformsubmission', 'form_data_pickle', self.gf('PickledObjectField')(_('form data pickle'), null=True, editable=False))
